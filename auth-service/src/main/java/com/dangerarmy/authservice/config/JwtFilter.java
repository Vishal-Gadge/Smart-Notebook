...
import com.dangerarmy.authservice.service.JwtService;
import com.dangerarmy.authservice.service.MyAppUserService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request){
        ...
        log.info("<<< SHOULD NOT FILTER CHECKING FOR>>>> :{}", path);
